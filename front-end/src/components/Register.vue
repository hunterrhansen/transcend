<template>
<div class="register">
	<div class="container" v-bind:class="{ 'right-panel-active': isActive }">
		...
		<div class="overlay-container">
			<div class="overlay">
				<div class="overlay-panel overlay-left">
					...
					<button class="ghost" @click="removeClass">Sign In</button>
				</div>
				<div class="overlay-panel overlay-right">
					<h1>Hello, Friend!</h1>
					<p>Enter your personal details and start journey with us</p>
					<button class="ghost" @click="addClass">Sign Up</button>
				</div>
			</div>
		</div>
	</div>
